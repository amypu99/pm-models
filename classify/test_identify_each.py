...
if __name__ == "__main__":
    ...
    aoe_noneprocbar_question = "In the text above, identify and return the text for any assignments of error involving misconduct by the prosecutor or state. If there is no mention of misconduct by the prosecutor or state, return 0."
